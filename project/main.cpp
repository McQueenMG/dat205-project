...
labhelper::Model* iceCreamCarModel = nullptr;

mat4 roomModelMatrix;
mat4 landingPadModelMatrix;
mat4 fighterModelMatrix;
mat4 iceCreamCarModelMatrix;
...
void initialize()
{
	...
	iceCreamCarModel = labhelper::loadModelFromOBJ("../scenes/ice_cream_car/ice_cream_car.obj");

	roomModelMatrix = mat4(1.0f);
	fighterModelMatrix = translate(15.0f * worldUp);
	landingPadModelMatrix = mat4(1.0f);
	// move car slightly up to avoid z-fighting with the ground plane
	iceCreamCarModelMatrix = translate(2.0f * worldUp);
               ...
               const mat4& lightProjectionMatrix)
{
	...
	// IceCreamCar
	labhelper::setUniformSlow(currentShaderProgram, "modelViewProjectionMatrix",
                          projectionMatrix * viewMatrix * iceCreamCarModelMatrix);
	labhelper::setUniformSlow(currentShaderProgram, "modelViewMatrix", viewMatrix * iceCreamCarModelMatrix);
	labhelper::setUniformSlow(currentShaderProgram, "normalMatrix",
							inverse(transpose(viewMatrix * iceCreamCarModelMatrix)));

	labhelper::render(iceCreamCarModel);
}
...
int main(int argc, char* argv[])
{
	...
	labhelper::freeModel(iceCreamCarModel);
